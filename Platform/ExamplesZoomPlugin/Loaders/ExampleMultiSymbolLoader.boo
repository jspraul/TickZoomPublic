...
class ExampleMultiSymbolLoader(ModelLoaderCommon):
	...
	override def OnLoad(properties as ProjectProperties):
		for symbol as SymbolInfo in properties.Starter.SymbolInfo:
			name as string = symbol.Symbol
			strategy as StrategyCommon = CreateStrategy('ExampleSimpleStrategy', ('ExampleOrder-' + name))
