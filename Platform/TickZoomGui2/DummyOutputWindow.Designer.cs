namespace TickZoom
{
    partial class DummyOutputWindow
    {
		...
		private void InitializeComponent()
		{
			...
			this.TabText = "Output";
			this.Text = "Output";
			this.Load += new System.EventHandler(this.DummyOutputWindowLoad);
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.DummyOutputWindowClosing);
