...
namespace Loaders
{
	...
	public class ExampleSimulatedTest : StrategyTest
	{
		...
		public void VerifyCurrentEquity() {
			Assert.AreEqual( Math.Round(9995.23,2),Math.Round(strategy.Performance.Equity.CurrentEquity,2),"current equity");
		}
		[Test]
		...
		public void VerifyClosedEquity() {
			Assert.AreEqual( Math.Round(9995.25,2),Math.Round(strategy.Performance.Equity.ClosedEquity,2),"closed equity");
		}
		[Test]
