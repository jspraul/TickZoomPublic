...
*/
	...
	#region Date Conversion Methods
		...
		public static int XLDateToWeekDay( double xlDate )
		{
...
/*
		...
		public static string ToString( double xlDate, string fmtStr )
		{
			...
			resultStr = resultStr.Replace( "&wwww", longDoW[ XLDateToWeekDay( xlDate ) ] );
			resultStr = resultStr.Replace( "&www", shortDoW[ XLDateToWeekDay( xlDate ) ] );
